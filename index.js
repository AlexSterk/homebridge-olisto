...
function OlistoAccessory(log, config, platform) {
    ...
    if (this.type != "push" && this.type != "switch" && this.type != "outlet" && this.type != "light") {
        log.error('Invalid type, please use "push", "switch", "light" or "outlet"!');
...
OlistoAccessory.prototype.getInformationService = function () {
    ...
    informationService
        ...
        .setCharacteristic(Characteristic.Manufacturer, 'Alexander Sterk')
...
OlistoAccessory.prototype.setOn = function (on, callback) {
    ...
    } else if (accessory.type == "switch" || accessory.type == "outlet" || accessory.type == "light") {
